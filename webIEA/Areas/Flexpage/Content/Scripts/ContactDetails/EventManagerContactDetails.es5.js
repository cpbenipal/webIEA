...
var EventManagerContactDetails = (function (_EventManagerBase) {
    _inherits(EventManagerContactDetails, _EventManagerBase);

    function EventManagerContactDetails() {
        _classCallCheck(this, EventManagerContactDetails);

        _get(Object.getPrototypeOf(EventManagerContactDetails.prototype), "constructor", this).call(this);
    ...
    _createClass(EventManagerContactDetails, [{
        key: "save",
        ...
        key: "toggleAddressCheckbox",
        value: function toggleAddressCheckbox(s, customEditors) {
            var checked = s.GetChecked();
            this.toggleAddressFields(!checked, customEditors);
            this.toggleAddressImportField(checked);
        }
    }, {
        key: "toggleAddressFields",
        value: function toggleAddressFields(value, customEditors) {
            var textFields = [StreetTextBox, ZipTextBox, CityTextBox, CountryComboBox, DescriptionTextBox];
            for (var i = 0; i < customEditors; i++) {
                textFields.push(eval("CustomPropertyEditor_" + i));
            }
            textFields.forEach(function (f) {
                return f.SetEnabled(value);
            });
        }
    }, {
        key: "toggleAddressImportField",
        value: function toggleAddressImportField(value) {
        ...
        key: "setAddressValue",
        value: function setAddressValue(source) {
            var ID = LinkedAddressSource.GetValue();
            var value = JSON.parse(source.cpAllAddressViewsJson).filter(function (el) {
                return el.ID === ID;
            })[0];
        ...
        key: "eventEdit",
        value: function eventEdit(e) {
            var args = e.data.args;
            EventManager.bus.publish(EventManager.settings.Events.contactDetails.edit, { "event": e, "ID": args.ID, "contactID": args.contactID, "contactType": args.contactType, "edit": true, "reload": true });
        }
    }, {
        key: "eventSave",
        ...
        key: "eventCancel",
        value: function eventCancel(e) {
            var args = e.data.args;
            EventManager.bus.publish(EventManager.settings.Events.contactDetails.cancel, { "event": e, "ID": args.ID, "contactID": args.contactID, "contactType": args.contactType, "edit": false, "reload": true });
        }
    }, {
        key: "eventGeneratePassword",
        value: function eventGeneratePassword(e) {
            var args = e.data.args;
            args.typeBlock = "ContactDetails";
        ...
        key: "eventRemoveAuth",
        value: function eventRemoveAuth(e) {
            var args = e.data.args;
    ...
    return EventManagerContactDetails;
})(EventManagerBase);
