...
class EventManagerBrowserSearch extends EventManagerBase {
    constructor(args) {
        super();
    ...
    clickContextMenu(args) {
        ...
        if (args.event.item.name === "Copy") {
            ...
            $("div.fp_textTreeListNode").filter(function (index, element) { return $(element).attr('data-path') == args.path; }).first().click();
