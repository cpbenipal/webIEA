...
class EventManagerContactsEnumeration extends EventManagerContent {
    constructor(args) {
        super();
    ...
    */
    clickContextMenu(args) {
        ...
        if (args.event.item.name === "Properties") {
            ...
            fp_popupControlOpen({ command: 'edit', blocklistID: '0', blockType: 'ObjectProperties', blockAlias: '', blockID: args.shortcutId, title: 'Properties: ' + contactName, parameters: "contact" },
                function (save) {
                    if (save) {
    ...
    */
    ...
    rowClick(args) {
        ...
        if (name) {
            ...
            $(".fp_contactDetails[data-alias=" + name + "]").each((index, cd) => {
                var _args = {};
