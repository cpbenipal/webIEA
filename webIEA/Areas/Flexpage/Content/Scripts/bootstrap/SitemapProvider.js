...
function SiteMapManagerAddNew(targetTag) {
    var isNewNode = true;
    targetKey = jQuery(targetTag).closest("h4.panel-title").find("a.sitemap-item").attr("data-resourceKey");
    targetNode = null;
    parentNode = null;
...
function SiteMapManagerSave() {
    // var jsonText = '{"titles":{"nl":"Home","fr":"Home"},"pageRefernces":null,"isreferences ":null,"descriptions":{"nl":"Home","fr":"Home"},"title":"Home","pageRefernce":null,"isreference":false,"key":"Home","description":"Home","visible":null,"readonly":null,"cms":null,"url":"/Home.aspx","target":null,"IsAnonymousOnly":true,"roles":"S-Members;H-Members","visibleRoles":"S-Members;H-Members;Members","languages":"nl;fr;en","nodes":[]}';
...
function SiteMapManagerEdit(targetTag) {
    ...
    if (targetNode != null) {
        ...
        jQuery("#page-sitemapsManager #txtPageUrl").text(targetNode["url"]);
