...
var EventManagerEnums = (function (_EventManagerBase) {
    _inherits(EventManagerEnums, _EventManagerBase);

    function EventManagerEnums() {
        _classCallCheck(this, EventManagerEnums);

        _get(Object.getPrototypeOf(EventManagerEnums.prototype), "constructor", this).call(this);
        EventManager.bus.installTo(this);
    }

    return EventManagerEnums;
})(EventManagerBase);
