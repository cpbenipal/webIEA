...
CustomElementFactory.prototype._getDefaultSize = function(semantic) {
  ...
  var shapes = {
    __default: { width: 220, height: 100 },
    'bpmn:ServiceTask': { width: 80, height: 80  },
    'bpmn:ManualTask': { width: 220, height: 130  },
    // 'custom:OR-operation': { width: 100, height: 80  },
    // 'custom:NOT-operation': { width: 100, height: 80  },
    // 'custom:condition': { width: 100, height: 80  },
    // 'custom:link': { width: 100, height: 80  }
  };
